    ...
    private fun HomeScreen(
        ...
        LazyColumn(
                    ...
                    Surface(
                        ...
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    "Refreshing yt-dlp if needed and reading the available streams.",
                                    color = MaterialTheme.colorScheme.onSurfaceVariant,
            ...
            inspection?.let { info ->
                ...
                items(info.qualities, key = { it.height }) { option ->
                    QualityCard(
                        option = option,
                        onClick = {
        ...
        LazyColumn(
            ...
            item {
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Text(
                        qualityLabel(record.quality) + " • " + FileSizeFormatter.format(record.estimatedBytes),
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                        style = MaterialTheme.typography.bodyMedium
                    )
                }
            ...
            Column(
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            qualityLabel(record.quality) + " • " + record.stage,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                            style = MaterialTheme.typography.bodySmall
                        )
                    }
